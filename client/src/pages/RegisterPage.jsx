  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        <p style={s.sub}>// a new raven joins the realm</p>
            ...
            {form.password.length > 0 && (
              <>
                <div style={s.strengthBar}>
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} style={{ ...s.strengthSeg, background: i <= score ? '#4ade80' : '#22222f' }} />
                  ))}
                </div>
                <div style={s.strengthLabel}>{strengthLabel[score]}</div>
              </>
            )}
          </div>
...
const s = {
  ...
  strengthLabel: { fontSize: 11, color: '#55556a', fontFamily: "'JetBrains Mono', monospace", marginTop: 4 },
